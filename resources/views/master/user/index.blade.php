    ...
    <div class="card mb-5 mb-xl-8">
        <div class="card-header border-0 pt-5">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label fw-bold fs-3 mb-1">List Master User</span>
            </h3>
        ...
        <div class="card-body py-3">
            <div class="table-responsive">
                ...
                <table class="table align-middle gs-0 gy-4">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                <a href="{{route('master.user.edit', $val->id)}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <form action="{{ route('master.user.destroy', $val->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
                ...
                {{ $user->onEachSide(1)->appends(array_merge(request()->query(), ['page' => $user->currentPage()]))->links('pagination::bootstrap-5') }}
            </div>
        </div>
    </div>
</div>
