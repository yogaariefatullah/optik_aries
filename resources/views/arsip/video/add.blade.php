    ...
    <div class="card mb-5 mb-xl-8 custom-form-input">
        <div class="card-header border-0 pt-5">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label fw-bold fs-3 mb-1">Tambah Video</span>
            </h3>
        </div>
        ...
        {{-- <div class="card-body py-3">
            ...
            <!--begin::Form-->
        <form  method="POST" action="{{ route('arsip.video.store') }}" enctype='multipart/form-data'>
            @csrf
...
@section('javascript')
    <script>
        ...
        // });
            ...
            let url = '{{ route("arsip.video.upload") }}';
