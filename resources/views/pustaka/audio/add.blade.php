    ...
    <div class="card mb-5 mb-xl-8 custom-form-input">
        <div class="card-header border-0 pt-5">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label fw-bold fs-3 mb-1">Tambah Pustaka Audio</span>
            </h3>
        </div>
        ...
        {{-- <div class="card-body py-3">
            ...
            <!--begin::Form-->
        <form  method="POST" action="{{ route('pustaka.audio.store') }}" enctype='multipart/form-data'>
            @csrf
            <div class="card-body custom-form-input">
                ...
                <div class="row">
                    <div class="form-group col-6">
                        ...
                        <input id="produksi" name="produksi" type="number" class="form-control"/>
                    </div>
                    <div class="form-group col-6">
                        <label>Tahun Produksi</label>
                        <div class="input-group" id="kt_td_picker_date_only" data-td-target-input="nearest" data-td-target-toggle="nearest">
                            <input id="kt_td_picker_date_only_input" name="tahun_produksi" type="text" class="form-control" data-td-target="#kt_td_picker_date_only"/>
...
@section('javascript')
    <script>
        ...
        $('#btn-upload').click(function() {
            ...
            let url = '{{ route("pustaka.audio.upload") }}';
