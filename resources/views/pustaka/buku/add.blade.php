    ...
    <div class="card mb-5 mb-xl-8 custom-form-input">
        <div class="card-header border-0 pt-5">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label fw-bold fs-3 mb-1">Tambah Pustaka Buku</span>
            </h3>
        </div>
        ...
        {{-- <div class="card-body py-3">
            ...
            <!--begin::Form-->
        <form  method="POST" action="{{ route('pustaka.buku.store') }}" enctype='multipart/form-data'>
            @csrf
            <div class="card-body custom-form-input">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-6">
                        ...
                        <div class="input-group" id="kt_td_picker_date_only" data-td-target-input="nearest" data-td-target-toggle="nearest">
                            <input id="kt_td_picker_date_only_input" name="tahun_terbit" type="text" class="form-control" data-td-target="#kt_td_picker_date_only"/>
                ...
                <div class="row">
                    <div class="form-group col-6">
                        ...
                        <input type="text" name="tipe_media" class="form-control"/>
                    </div>
                    <div class="form-group col-6">
                        <label>Bahasa</label>
                ...
                <div class="row">
                    <div class="form-group col-12">
                        ...
                        <textarea class="form-control" name="deskripsi" id="exampleTextarea" rows="3"></textarea>
                    </div>
                </div>
                &nbsp;
...
@section('javascript')
    <script>
        ...
        // });
            ...
            let url = '{{ route("pustaka.buku.upload") }}';
