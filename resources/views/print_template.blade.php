<title>Aries Optical</title>
    ...
    <style type="text/css">
        @media print {
            ...
            header, footer {
                display: none; /* Menyembunyikan header dan footer */
            }
            .no-print {
                display: none;
            }
                        ...
                        <tr>
                            <td colspan="10">
                                <div class="form-group row">
                                    ...
                                    <label  class="col-4 col-form-label">{{$text_lensa->nama_barang}}</label>
                        ...
                        <tr>
                            <td colspan="10">
                                <div class="form-group row">
                                    ...
                                    <label  class="col-4 col-form-label">{{$text_frame->nama_barang}}</label>
