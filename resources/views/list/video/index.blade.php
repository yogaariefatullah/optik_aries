    ...
    <div class=" mb-5 mb-xl-8">
        ...
        <div class="card-body py-2">
            <div class="card-px text-center pt-10">
                <h2 class="fs-2x fw-bold mb-0">Koleksi Video Player</h2>
                <p class="text-gray-500 fs-4 fw-semibold">Koleksi Video kami ditampilkan di sini. Carilah mereka. Baca mereka. Semoga Anda juga menyukainya.</p>
            </div>
            ...
            <div class="row g-6 g-xl-9 mb-6 mb-xl-9" id="pustaka-video">
                @foreach($pustaka_video as $value)
                        ...
                        <div class="card-body d-flex justify-content-center text-center flex-column p-8">
                            <a onclick="showDetail()" class="text-gray-800 text-hover-primary d-flex flex-column" style="cursor:pointer!important;">
                                <div class="symbol symbol-200px mb-5">
                                    <img src="{{asset('uploads/pustaka-video/cover/'.$value->cover)}}" class="theme-light-show" alt="" />
                                </div>
                                <div class="fs-5 fw-bold mb-2">{{$value->subjek}}</div>
                            </a>
                            <form id="postForm" action="{{ route("list.video.detail") }}" method="POST" style="display: none;">
                                @csrf
